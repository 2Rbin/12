...
def generate_morning_message():
    ...
    if "candidates" not in result:
        fallbacks = [
            "🌸 Емілія, доброго ранку! Твоя посмішка освітлює весь день 💛 Гарного дня!",
            "🌺 Доброго ранку, Емілія! Ти неймовірна і особлива ✨ Нехай день буде чудовим!",
            "🌷 Привіт, Емілія! Сьогодні буде чудовий день, бо ти в ньому є 💫",
            "🌼 Доброго ранку! Ти найкраща і найяскравіша 🌟 Гарного дня, Емілія!",
        ]
