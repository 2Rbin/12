...
COMPLIMENTS = [
    ...
    "Твоя красота всередині і зовні 🪞", "Ти така дивовижна людина 🦋",
    "Твоя присутність змінює атмосферу 🌤️", "Ти вмієш любити щиро і глибоко ❤️‍🔥",
    "Твоя усмішка — найкращий початок дня 🌄", "Ти така неповторна — це твій найбільший дар 🎀",
]

# === 100+ ПОРАД ===
DAILY_TIPS = [
    "💧 Випий склянку води одразу після пробудження — це запускає метаболізм",
    "🚶 Пройди 10 хвилин пішки після їжі — допомагає травленню",
    ...
    "😴 Лягай спати до 23:00 — це найкорисніший сон",
    "🎯 Запиши три цілі на сьогодні вранці",
    "🧴 Не забувай про SPF кожного дня, навіть взимку",
    "💃 Потанцюй 5 хвилин під улюблену пісню — піднімає настрій",
    "🫖 Замість кави вранці спробуй зелений чай",
    "📝 Веди щоденник вдячності — записуй 3 речі щодня",
    "🌬️ Провітрюй кімнату щоранку хоча б 5 хвилин",
    "🧠 Вчи одне нове слово іноземної мови щодня",
    "🤸 Розтягуйся 5 хвилин перед сном",
    "🫂 Обіймай близьких частіше — це знижує стрес",
    "🎨 Виділи 15 хвилин на творчість щодня",
    "🌅 Подивись на захід або схід сонця — перезавантажує думки",
    "💊 Перевір чи вживаєш достатньо вітаміну D",
    "🧹 Прибери один маленький безлад — стає легше на душі",
    ...
    "🧊 Вмийся холодною водою вранці — бадьорить краще кави",
    "🌱 Полий рослини або просто зупинись біля зелені",
    ...
    "🫀 Перевір свій пульс — знай свою норму",
    ...
    "🧽 Протри дзеркало — чистота навколо = ясність думок",
    "🎯 Зроби одну справу яку відкладала",
    "🫧 Пий воду з лимоном — очищає організм",
    "🦷 Використовуй зубну нитку — маленька звичка, великий ефект",
...
async def advice(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    prompt = (
        ...
        "Поясни чому це корисно і як це зробити. Українською. Емодзі. Максимум 100 слів."
    )
    result = ask_gemini(prompt)
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    global WAITING_MOOD, BAD_MOOD_CHAT
